...
public class TemperatureControllerIdlePlotViewModel : TemperatureControllerViewModel
{
    ...
    public TemperatureControllerIdlePlotViewModel(string name, TemperatureControllerKey key): base(name, key)
    {
